...
Oryn action receipts use schema version 2. Ready actions pin their Attempt, repository, branch/base and delivery-check setting before dispatch. The `20260908-oryn-ready-target` central migration preserves legacy receipts without inferring missing targets; those records cannot automatically finalize readiness. See the [GitHub ready decision](../decisions/implemented/bug-fix/2026-09-08-oryn-github-ready-transition.md).
