...
Oryn GitHub intake uses version 1 `oryn/github` work records, `oryn/github_cursors` repository checkpoints and `oryn/github_owned` Inbox observations. `oryn/discoveries` retains version 1 lineage before child Case creation. Preserve these namespaces with Cases, Sessions and publication receipts during backup; deleting cursors or uncertain review receipts can lose replay identity. See [GitHub intake and setup](../decisions/implemented/feature/2026-09-08-oryn-github-loop-and-setup.md).
