...
Separate-process investigation and Issue acknowledgment recovery are covered by [publication crash recovery](2026-09-08-oryn-publication-crash-recovery.md); new Attempts and tasks after takeover/cancel use [ownership resume](2026-09-08-oryn-ownership-resume.md). Full PR delivery across process death and orphan-process cleanup still require separate acceptance. These simulated interruption tests do not establish exactly-once arbitrary shell actions or live GitHub/Feishu delivery.
